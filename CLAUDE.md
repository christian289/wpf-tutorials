...
7. **ViewModel 프로젝트에서 PresentationFramework.dll 직접 참조** - CollectionViewSource 사용 불가
8. **ViewModel에서 ICollectionView 타입 사용** - IEnumerable로 받아야 함
9. **CollectionView 없이 여러 View에서 개별 컬렉션 관리** - 데이터 동기화 문제 발생
